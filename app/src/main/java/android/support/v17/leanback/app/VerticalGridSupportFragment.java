  ...
  extends BaseSupportFragment
{
  ...
  private final OnItemViewSelectedListener mViewSelectedListener = new OnItemViewSelectedListener()
  {
    ...
    {
      int i = VerticalGridSupportFragment.this.mGridViewHolder.getGridView().getSelectedPosition();
      if (VerticalGridSupportFragment.DEBUG) {
        Log.v("VerticalGridSupportFragment", "grid selected position " + i);
      }
      VerticalGridSupportFragment.this.gridOnItemSelected(i);
      if (VerticalGridSupportFragment.this.mOnItemViewSelectedListener != null) {
        VerticalGridSupportFragment.this.mOnItemViewSelectedListener.onItemSelected(paramAnonymousViewHolder, paramAnonymousObject, paramAnonymousViewHolder1, paramAnonymousRow);
      }
    }
  };
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/android/support/v17/leanback/app/VerticalGridSupportFragment.class
