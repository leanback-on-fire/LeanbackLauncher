  ...
  extends BaseRowFragment
{
      ...
      localView.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymous2View)
        {
          if (HeadersFragment.this.mOnHeaderClickedListener != null) {
            HeadersFragment.this.mOnHeaderClickedListener.onHeaderClicked((RowHeaderPresenter.ViewHolder)paramAnonymousViewHolder.getViewHolder(), (Row)paramAnonymousViewHolder.getItem());
          }
        }
      });
      if (HeadersFragment.this.mWrapper != null)
      {
        paramAnonymousViewHolder.itemView.addOnLayoutChangeListener(HeadersFragment.sLayoutChangeListener);
        return;
      }
      localView.addOnLayoutChangeListener(HeadersFragment.sLayoutChangeListener);
    }
  };
  ...
  final ItemBridgeAdapter.Wrapper mWrapper = new ItemBridgeAdapter.Wrapper()
  {
    ...
    {
      return new HeadersFragment.NoOverlappingFrameLayout(paramAnonymousView.getContext());
    }
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/android/support/v17/leanback/app/HeadersFragment.class
