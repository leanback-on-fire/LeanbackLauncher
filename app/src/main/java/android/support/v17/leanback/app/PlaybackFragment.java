  ...
  extends Fragment
{
  ...
  private final ItemBridgeAdapter.AdapterListener mAdapterListener = new ItemBridgeAdapter.AdapterListener()
  {
    ...
    public void onCreate(ItemBridgeAdapter.ViewHolder paramAnonymousViewHolder)
    {
      ...
      if ((paramAnonymousViewHolder instanceof PlaybackSeekUi)) {
        ((PlaybackSeekUi)paramAnonymousViewHolder).setPlaybackSeekUiClient(PlaybackFragment.this.mChainedClient);
      }
    }
  ...
  final PlaybackSeekUi.Client mChainedClient = new PlaybackSeekUi.Client()
  {
    ...
    {
      if (PlaybackFragment.this.mSeekUiClient != null) {
        PlaybackFragment.this.mSeekUiClient.onSeekFinished(paramAnonymousBoolean);
      }
    ...
    {
      if (PlaybackFragment.this.mSeekUiClient != null) {
        PlaybackFragment.this.mSeekUiClient.onSeekPositionChanged(paramAnonymousLong);
      }
    }
  ...
  private final Animator.AnimatorListener mFadeListener = new Animator.AnimatorListener()
  {
    ...
    public void onAnimationEnd(Animator paramAnonymousAnimator)
    {
      ...
      {
        return;
        paramAnonymousAnimator = PlaybackFragment.this.getVerticalGridView();
      ...
      } while (PlaybackFragment.this.mFadeCompleteListener == null);
  ...
  private final Handler mHandler = new Handler()
  {
    ...
    {
      if ((paramAnonymousMessage.what == PlaybackFragment.START_FADE_OUT) && (PlaybackFragment.this.mFadingEnabled)) {
  ...
  private final BaseOnItemViewClickedListener mOnItemViewClickedListener = new BaseOnItemViewClickedListener()
  {
    ...
    {
      if ((PlaybackFragment.this.mPlaybackItemClickedListener != null) && ((paramAnonymousViewHolder1 instanceof PlaybackRowPresenter.ViewHolder))) {
        PlaybackFragment.this.mPlaybackItemClickedListener.onItemClicked(paramAnonymousViewHolder, paramAnonymousObject1, paramAnonymousViewHolder1, paramAnonymousObject2);
      }
      if (PlaybackFragment.this.mExternalItemClickedListener != null) {
        PlaybackFragment.this.mExternalItemClickedListener.onItemClicked(paramAnonymousViewHolder, paramAnonymousObject1, paramAnonymousViewHolder1, paramAnonymousObject2);
      }
    }
  };
  private final BaseOnItemViewSelectedListener mOnItemViewSelectedListener = new BaseOnItemViewSelectedListener()
  {
    public void onItemSelected(Presenter.ViewHolder paramAnonymousViewHolder, Object paramAnonymousObject1, RowPresenter.ViewHolder paramAnonymousViewHolder1, Object paramAnonymousObject2)
    {
      if (PlaybackFragment.this.mExternalItemSelectedListener != null) {
        PlaybackFragment.this.mExternalItemSelectedListener.onItemSelected(paramAnonymousViewHolder, paramAnonymousObject1, paramAnonymousViewHolder1, paramAnonymousObject2);
      }
    }
  };
  private final BaseGridView.OnKeyInterceptListener mOnKeyInterceptListener = new BaseGridView.OnKeyInterceptListener()
  {
    ...
    {
      return PlaybackFragment.this.onInterceptInputEvent(paramAnonymousKeyEvent);
    }
  };
  private final BaseGridView.OnTouchInterceptListener mOnTouchInterceptListener = new BaseGridView.OnTouchInterceptListener()
  {
    ...
    {
      return PlaybackFragment.this.onInterceptInputEvent(paramAnonymousMotionEvent);
    }
  };
  ...
  private void loadBgAnimator()
  {
    ValueAnimator.AnimatorUpdateListener local7 = new ValueAnimator.AnimatorUpdateListener()
    {
      ...
      {
        PlaybackFragment.this.setBgAlpha(((Integer)paramAnonymousValueAnimator.getAnimatedValue()).intValue());
      }
    };
    ...
    ValueAnimator.AnimatorUpdateListener local8 = new ValueAnimator.AnimatorUpdateListener()
    {
      public void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        ...
        do
        {
          ...
          {
            return;
            localObject = PlaybackFragment.this.getVerticalGridView().findViewHolderForAdapterPosition(0);
          } while (localObject == null);
          localObject = ((RecyclerView.ViewHolder)localObject).itemView;
        } while (localObject == null);
        float f = ((Float)paramAnonymousValueAnimator.getAnimatedValue()).floatValue();
        ((View)localObject).setAlpha(f);
        ((View)localObject).setTranslationY(PlaybackFragment.this.mAnimationTranslateY * (1.0F - f));
      }
    };
    Context localContext = FragmentUtil.getContext(this);
    ...
    ValueAnimator.AnimatorUpdateListener local9 = new ValueAnimator.AnimatorUpdateListener()
    {
      public void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        ...
        for (;;)
        {
          return;
          float f = ((Float)paramAnonymousValueAnimator.getAnimatedValue()).floatValue();
          int j = PlaybackFragment.this.getVerticalGridView().getChildCount();
          int i = 0;
          while (i < j)
          {
            paramAnonymousValueAnimator = PlaybackFragment.this.getVerticalGridView().getChildAt(i);
            if (PlaybackFragment.this.getVerticalGridView().getChildAdapterPosition(paramAnonymousValueAnimator) > 0)
            {
              paramAnonymousValueAnimator.setAlpha(f);
              paramAnonymousValueAnimator.setTranslationY(PlaybackFragment.this.mAnimationTranslateY * (1.0F - f));
            }
            i += 1;
          }
        }
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/android/support/v17/leanback/app/PlaybackFragment.class
