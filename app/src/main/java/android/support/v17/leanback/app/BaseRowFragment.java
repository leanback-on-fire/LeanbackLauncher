  ...
  extends Fragment
{
  ...
  private final OnChildViewHolderSelectedListener mRowSelectedListener = new OnChildViewHolderSelectedListener()
  {
    public void onChildViewHolderSelected(RecyclerView paramAnonymousRecyclerView, RecyclerView.ViewHolder paramAnonymousViewHolder, int paramAnonymousInt1, int paramAnonymousInt2)
    {
      ...
      {
        BaseRowFragment.this.mSelectedPosition = paramAnonymousInt1;
        BaseRowFragment.this.onRowSelected(paramAnonymousRecyclerView, paramAnonymousViewHolder, paramAnonymousInt1, paramAnonymousInt2);
      }
    }
  };
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/android/support/v17/leanback/app/BaseRowFragment.class
