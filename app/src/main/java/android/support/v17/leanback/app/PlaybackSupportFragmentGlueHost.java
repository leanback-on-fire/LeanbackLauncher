  ...
  implements PlaybackSeekUi
{
  ...
  final PlaybackGlueHost.PlayerCallback mPlayerCallback = new PlaybackGlueHost.PlayerCallback()
  {
    ...
    {
      PlaybackSupportFragmentGlueHost.this.mFragment.onBufferingStateChanged(paramAnonymousBoolean);
    }
    
    public void onError(int paramAnonymousInt, CharSequence paramAnonymousCharSequence)
    {
      PlaybackSupportFragmentGlueHost.this.mFragment.onError(paramAnonymousInt, paramAnonymousCharSequence);
    }
    
    public void onVideoSizeChanged(int paramAnonymousInt1, int paramAnonymousInt2)
    {
      PlaybackSupportFragmentGlueHost.this.mFragment.onVideoSizeChanged(paramAnonymousInt1, paramAnonymousInt2);
    }
  };
  
  public PlaybackSupportFragmentGlueHost(PlaybackSupportFragment paramPlaybackSupportFragment)
  {
    this.mFragment = paramPlaybackSupportFragment;
  }
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/android/support/v17/leanback/app/PlaybackSupportFragmentGlueHost.class
