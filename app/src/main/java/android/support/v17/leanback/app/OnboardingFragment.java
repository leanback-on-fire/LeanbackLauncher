  ...
  extends Fragment
{
  ...
  private void onPageChangedInternal(int paramInt)
  {
    ...
    if (paramInt < getCurrentPageIndex())
    {
      ...
      ((Animator)localObject).addListener(new AnimatorListenerAdapter()
      {
        ...
        {
          OnboardingFragment.this.mTitleView.setText(OnboardingFragment.this.getPageTitle(this.val$currentPageIndex));
          OnboardingFragment.this.mDescriptionView.setText(OnboardingFragment.this.getPageDescription(this.val$currentPageIndex));
        }
      });
      localObject = FragmentUtil.getContext(this);
  ...
  void hideLogoView()
  {
    ...
    Object localObject = getThemeInflater(LayoutInflater.from(FragmentUtil.getContext(this)));
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    paramViewGroup = FragmentUtil.getContext(this);
    if (sSlideDistance == 0) {
  ...
  protected final void startEnterAnimation(boolean paramBoolean)
  {
    ...
    ArrayList localArrayList = new ArrayList();
    Animator localAnimator = AnimatorInflater.loadAnimator(FragmentUtil.getContext(this), R.animator.lb_onboarding_page_indicator_enter);
    if (getPageCount() <= 1) {}
  ...
  {
    final Context localContext = FragmentUtil.getContext(this);
    Object localObject;
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/android/support/v17/leanback/app/OnboardingFragment.class
