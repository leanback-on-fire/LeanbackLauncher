  ...
  extends DetailsSupportFragment
{
  ...
  private final ItemBridgeAdapter.AdapterListener mAdapterListener = new ItemBridgeAdapter.AdapterListener()
  {
    public void onAttachedToWindow(ItemBridgeAdapter.ViewHolder paramAnonymousViewHolder)
    {
      ...
      if ((paramAnonymousViewHolder.getPosition() == 0) && (PlaybackOverlaySupportFragment.this.mResetControlsToPrimaryActionsPending)) {
        PlaybackOverlaySupportFragment.this.resetControlsToPrimaryActions(paramAnonymousViewHolder);
      }
    }
    ...
    public void onBind(ItemBridgeAdapter.ViewHolder paramAnonymousViewHolder)
    {
      if (paramAnonymousViewHolder.getPosition() == 0) {
        PlaybackOverlaySupportFragment.this.updateControlsBottomSpace(paramAnonymousViewHolder);
      }
    }
  ...
  private final Animator.AnimatorListener mFadeListener = new Animator.AnimatorListener()
  {
    ...
    public void onAnimationEnd(Animator paramAnonymousAnimator)
    {
      ...
      for (;;)
      {
        ...
        return;
        paramAnonymousAnimator = PlaybackOverlaySupportFragment.this.getVerticalGridView();
  ...
  private final BaseGridView.OnKeyInterceptListener mOnKeyInterceptListener = new BaseGridView.OnKeyInterceptListener()
  {
    ...
    {
      return PlaybackOverlaySupportFragment.this.onInterceptInputEvent(paramAnonymousKeyEvent);
    }
  };
  private final BaseGridView.OnTouchInterceptListener mOnTouchInterceptListener = new BaseGridView.OnTouchInterceptListener()
  {
    ...
    {
      return PlaybackOverlaySupportFragment.this.onInterceptInputEvent(paramAnonymousMotionEvent);
    }
  };
  ...
  private void loadBgAnimator()
  {
    ValueAnimator.AnimatorUpdateListener local4 = new ValueAnimator.AnimatorUpdateListener()
    {
      ...
      {
        PlaybackOverlaySupportFragment.this.setBgAlpha(((Integer)paramAnonymousValueAnimator.getAnimatedValue()).intValue());
      }
    };
  ...
  private void loadControlRowAnimator()
  {
    AnimatorListener local5 = new AnimatorListener()
    {
      ...
      {
        View localView = PlaybackOverlaySupportFragment.this.getControlRowView();
        if (localView != null) {
    ...
    ValueAnimator.AnimatorUpdateListener local6 = new ValueAnimator.AnimatorUpdateListener()
    {
      public void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        ...
        if (localView != null)
        {
          ...
          localView.setTranslationY(PlaybackOverlaySupportFragment.this.mAnimationTranslateY * (1.0F - f));
        }
      }
    };
    Context localContext = getContext();
    ...
    ValueAnimator.AnimatorUpdateListener local9 = new ValueAnimator.AnimatorUpdateListener()
    {
      public void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        ...
        do
        {
          ...
          {
            return;
            localObject = (ItemBridgeAdapter.ViewHolder)PlaybackOverlaySupportFragment.this.getVerticalGridView().findViewHolderForPosition(0);
  ...
  private void loadOtherRowAnimator()
  {
    final AnimatorListener local7 = new AnimatorListener()
    {
      void getViews(ArrayList<View> paramAnonymousArrayList)
      {
        ...
        {
          return;
          int j = PlaybackOverlaySupportFragment.this.getVerticalGridView().getChildCount();
          int i = 0;
          while (i < j)
          {
            View localView = PlaybackOverlaySupportFragment.this.getVerticalGridView().getChildAt(i);
            if (localView != null) {
              paramAnonymousArrayList.add(localView);
            }
            i += 1;
      ...
      public void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        ...
        for (;;)
        {
          ...
          while (paramAnonymousValueAnimator.hasNext())
          {
            ...
            if (PlaybackOverlaySupportFragment.this.getVerticalGridView().getChildPosition(localView) > 0)
            {
              localView.setAlpha(f);
              localView.setTranslationY(PlaybackOverlaySupportFragment.this.mAnimationTranslateY * (1.0F - f));
            }
    ...
    extends Handler
  {
    ...
    {
      if (paramMessage.what == PlaybackOverlaySupportFragment.START_FADE_OUT)
      {
        paramMessage = (PlaybackOverlaySupportFragment)((WeakReference)paramMessage.obj).get();
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/android/support/v17/leanback/app/PlaybackOverlaySupportFragment.class
