  ...
  implements GuidedActionAdapter.FocusListener
{
  ...
  public static int add(FragmentManager paramFragmentManager, GuidedStepFragment paramGuidedStepFragment)
  {
    return add(paramFragmentManager, paramGuidedStepFragment, 16908290);
  }
  
  public static int add(FragmentManager paramFragmentManager, GuidedStepFragment paramGuidedStepFragment, int paramInt)
  {
    int j = 0;
    GuidedStepFragment localGuidedStepFragment = getCurrentGuidedStepFragment(paramFragmentManager);
    if (localGuidedStepFragment != null)
    {
      i = 1;
      if ((Build.VERSION.SDK_INT >= 21) && (Build.VERSION.SDK_INT < 23) && (i == 0)) {
        paramFragmentManager.beginTransaction().replace(paramInt, new DummyFragment(), "leanBackGuidedStepFragment").commit();
      }
    ...
    for (int i = j;; i = 1)
    {
      paramGuidedStepFragment.setUiStyle(i);
      paramFragmentManager.addToBackStack(paramGuidedStepFragment.generateStackEntryName());
      if (localGuidedStepFragment != null) {
        paramGuidedStepFragment.onAddSharedElementTransition(paramFragmentManager, localGuidedStepFragment);
      }
      return paramFragmentManager.replace(paramInt, paramGuidedStepFragment, "leanBackGuidedStepFragment").commit();
      i = 0;
      break;
    }
  }
  
  public static int addAsRoot(Activity paramActivity, GuidedStepFragment paramGuidedStepFragment, int paramInt)
  {
    paramActivity.getWindow().getDecorView();
    paramActivity = paramActivity.getFragmentManager();
    if (paramActivity.findFragmentByTag("leanBackGuidedStepFragment") != null)
    {
      Log.w("GuidedStepFragment", "Fragment is already exists, likely calling addAsRoot() when savedInstanceState is not null in Activity.onCreate().");
      return -1;
    }
    paramActivity = paramActivity.beginTransaction();
    paramGuidedStepFragment.setUiStyle(2);
    return paramActivity.replace(paramInt, paramGuidedStepFragment, "leanBackGuidedStepFragment").commit();
  }
  ...
  public static GuidedStepFragment getCurrentGuidedStepFragment(FragmentManager paramFragmentManager)
  {
    paramFragmentManager = paramFragmentManager.findFragmentByTag("leanBackGuidedStepFragment");
    if ((paramFragmentManager instanceof GuidedStepFragment)) {
      return (GuidedStepFragment)paramFragmentManager;
    }
    return null;
  }
  ...
  static String getGuidedStepFragmentClassName(String paramString)
  {
  ...
  {
    Object localObject = FragmentUtil.getContext(this);
  ...
  public void finishGuidedStepFragments()
  {
    ...
    if (i > 0)
    {
      ...
      while (i >= 0)
      {
        ...
        {
          GuidedStepFragment localGuidedStepFragment = getCurrentGuidedStepFragment(localFragmentManager);
          if (localGuidedStepFragment != null) {
            localGuidedStepFragment.setUiStyle(1);
          }
  ...
  protected void onAddSharedElementTransition(FragmentTransaction paramFragmentTransaction, GuidedStepFragment paramGuidedStepFragment)
  {
    paramGuidedStepFragment = paramGuidedStepFragment.getView();
    addNonNullSharedElementTransition(paramFragmentTransaction, paramGuidedStepFragment.findViewById(R.id.action_fragment_root), "action_fragment_root");
    addNonNullSharedElementTransition(paramFragmentTransaction, paramGuidedStepFragment.findViewById(R.id.action_fragment_background), "action_fragment_background");
    addNonNullSharedElementTransition(paramFragmentTransaction, paramGuidedStepFragment.findViewById(R.id.action_fragment), "action_fragment");
    addNonNullSharedElementTransition(paramFragmentTransaction, paramGuidedStepFragment.findViewById(R.id.guidedactions_root), "guidedactions_root");
    addNonNullSharedElementTransition(paramFragmentTransaction, paramGuidedStepFragment.findViewById(R.id.guidedactions_content), "guidedactions_content");
    addNonNullSharedElementTransition(paramFragmentTransaction, paramGuidedStepFragment.findViewById(R.id.guidedactions_list_background), "guidedactions_list_background");
    addNonNullSharedElementTransition(paramFragmentTransaction, paramGuidedStepFragment.findViewById(R.id.guidedactions_root2), "guidedactions_root2");
    addNonNullSharedElementTransition(paramFragmentTransaction, paramGuidedStepFragment.findViewById(R.id.guidedactions_content2), "guidedactions_content2");
    addNonNullSharedElementTransition(paramFragmentTransaction, paramGuidedStepFragment.findViewById(R.id.guidedactions_list_background2), "guidedactions_list_background2");
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    paramLayoutInflater = new GuidedActionAdapter.EditListener()
    {
      ...
      {
        GuidedStepFragment.this.onGuidedActionEditCanceled(paramAnonymousGuidedAction);
      }
      
      public long onGuidedActionEditedAndProceed(GuidedAction paramAnonymousGuidedAction)
      {
        return GuidedStepFragment.this.onGuidedActionEditedAndProceed(paramAnonymousGuidedAction);
      }
    ...
    this.mAdapter = new GuidedActionAdapter(this.mActions, new GuidedActionAdapter.ClickListener()
    {
      ...
      {
        GuidedStepFragment.this.onGuidedActionClicked(paramAnonymousGuidedAction);
        ...
        GuidedStepFragment.this.expandAction(paramAnonymousGuidedAction, true);
      }
    ...
    this.mSubAdapter = new GuidedActionAdapter(null, new GuidedActionAdapter.ClickListener()
    {
      public void onGuidedActionClicked(GuidedAction paramAnonymousGuidedAction)
      {
        if (GuidedStepFragment.this.mActionsStylist.isInExpandTransition()) {}
        while (!GuidedStepFragment.this.onSubGuidedActionClicked(paramAnonymousGuidedAction)) {
          return;
        }
    ...
    if (this.mThemeWrapper != null) {}
    for (paramLayoutInflater = this.mThemeWrapper;; paramLayoutInflater = FragmentUtil.getContext(this))
    {
  ...
  public void popBackStackToGuidedStepFragment(Class paramClass, int paramInt)
  {
    if (!GuidedStepFragment.class.isAssignableFrom(paramClass)) {}
    for (;;)
    {
      return;
      FragmentManager localFragmentManager = getFragmentManager();
      ...
      if (i > 0)
      {
        ...
        {
          FragmentManager.BackStackEntry localBackStackEntry = localFragmentManager.getBackStackEntryAt(i);
          if (paramClass.equals(getGuidedStepFragmentClassName(localBackStackEntry.getName())))
          {
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/android/support/v17/leanback/app/GuidedStepFragment.class
