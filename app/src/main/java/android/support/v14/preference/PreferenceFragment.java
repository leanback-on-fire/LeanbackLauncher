  ...
  implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment
{
  ...
  private void scrollToPreferenceInternal(final Preference paramPreference, final String paramString)
  {
    paramPreference = new Runnable()
    {
      public void run()
      {
        RecyclerView.Adapter localAdapter = PreferenceFragment.this.mList.getAdapter();
        ...
        localAdapter.registerAdapterDataObserver(new PreferenceFragment.ScrollToPreferenceObserver(localAdapter, PreferenceFragment.this.mList, paramPreference, paramString));
      }
    };
    if (this.mList == null)
    {
  ...
  {
    Object localObject = this.mStyledContext.obtainStyledAttributes(null, R.styleable.PreferenceFragment, TypedArrayUtils.getAttr(this.mStyledContext, R.attr.preferenceFragmentStyle, 16844038), 0);
    this.mLayoutResId = ((TypedArray)localObject).getResourceId(R.styleable.PreferenceFragment_android_layout, this.mLayoutResId);
  ...
  {
    public abstract boolean onPreferenceDisplayDialog(@NonNull PreferenceFragment paramPreferenceFragment, Preference paramPreference);
  }
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/android/support/v14/preference/PreferenceFragment.class
