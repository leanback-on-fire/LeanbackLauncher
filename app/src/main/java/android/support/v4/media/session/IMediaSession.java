  ...
  extends IInterface
{
    ...
    implements IMediaSession
  {
      ...
      throws RemoteException
    {
      ...
      case 38: 
        paramParcel1.enforceInterface("android.support.v4.media.session.IMediaSession");
        bool = isShuffleModeEnabledDeprecated();
        paramParcel2.writeNoException();
        paramInt1 = m;
        if (bool) {
          paramInt1 = 1;
      ...
      case 40: 
        ...
        for (bool = true;; bool = false)
        {
          setShuffleModeEnabledDeprecated(bool);
          paramParcel2.writeNoException();
          return true;
        }
      case 48: 
      ...
      implements IMediaSession
    {
        ...
        throws RemoteException
      {
        ...
        //   34: invokevirtual 75	android/os/Parcel:readInt	()I
        //   37: ifeq +26 -> 63
        //   40: getstatic 142	android/support/v4/media/session/ParcelableVolumeInfo:CREATOR	Landroid/os/Parcelable$Creator;
        //   43: aload_3
        //   44: invokeinterface 87 2 0
        //   49: checkcast 141	android/support/v4/media/session/ParcelableVolumeInfo
        //   52: astore_1
        //   53: aload_3
        //   54: invokevirtual 58	android/os/Parcel:recycle	()V
        //   57: aload_2
        ...
        throws RemoteException
      {
        ...
        //   30: aload_3
        //   31: iconst_0
        //   32: invokevirtual 152	android/os/Bundle:writeToParcel	(Landroid/os/Parcel;I)V
        //   35: aload_0
        //   36: getfield 19	android/support/v4/media/session/IMediaSession$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   39: bipush 14
        //   41: aload_3
        ...
        throws RemoteException
      {
        ...
        //   24: aload_2
        //   25: iconst_0
        //   26: invokevirtual 168	android/support/v4/media/RatingCompat:writeToParcel	(Landroid/os/Parcel;I)V
        //   29: aload_0
        //   30: getfield 19	android/support/v4/media/session/IMediaSession$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   33: bipush 25
        //   35: aload_2
        ...
        throws RemoteException
      {
        ...
        //   25: aload_2
        //   26: aload_1
        //   27: invokevirtual 177	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
        //   30: aload_0
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/android/support/v4/media/session/IMediaSession.class
