    ...
    for (;;)
    {
      ...
      if (i == 2)
      {
        ...
        for (;;)
        {
          ...
          {
            paramString = (String)localObject1;
            if ("external-cache-path".equals(localObject2))
            {
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/android/support/v4/content/FileProvider.class
