        ...
        do
        {
          do
          {
            do
            {
              ...
              } while (f1 * this.mVelocityTracker.getXVelocity(m) + f2 * this.mVelocityTracker.getYVelocity(m) >= 0.0F);
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/android/support/v4/view/GestureDetectorCompat.class
