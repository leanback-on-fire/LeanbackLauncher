...
public class LegacyAppOrderPreferenceFragment extends GuidedStepFragment {
    ...
    public void onCreateActions(List<GuidedAction> actions, Bundle savedInstanceState) {
        ...
        actions.add(((Builder) ((Builder) ((Builder) ((Builder) ((Builder) new Builder(getActivity()).id(1)).checkSetId(1)).checked(sortingMode == SortingMode.RECENCY)).title((int) R.string.select_app_order_action_description_recency)).description((int) R.string.recency_order_action_description)).build());
        Builder builder = (Builder) ((Builder) new Builder(getActivity()).id(2)).checkSetId(1);
        if (sortingMode != SortingMode.FIXED) {
            z = false;
        }
        actions.add(((Builder) ((Builder) ((Builder) builder.checked(z)).title((int) R.string.select_app_order_action_description_fixed)).description((int) R.string.fixed_order_action_description)).build());
    }
