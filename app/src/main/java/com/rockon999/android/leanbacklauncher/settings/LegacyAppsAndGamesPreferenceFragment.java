...
public class LegacyAppsAndGamesPreferenceFragment extends GuidedStepFragment {
    ...
    public void onResume() {
        ...
        actions.add(((Builder) ((Builder) ((Builder) new Builder(getActivity()).id(1)).title((int) R.string.home_screen_order_content_title)).description(sortingMode == SortingMode.FIXED ? R.string.select_app_order_action_description_fixed : R.string.select_app_order_action_description_recency)).build());
        if (sortingMode == SortingMode.FIXED) {
            actions.add(((Builder) ((Builder) new Builder(getActivity()).id(2)).title((int) R.string.customize_app_order_action_title)).build());
            actions.add(((Builder) ((Builder) new Builder(getActivity()).id(3)).title((int) R.string.customize_game_order_action_title)).build());
        }
        setActions(actions);
    }
