    ...
    public static abstract class Stub extends Binder implements IRecommendationsService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.tvrecommendations.IRecommendationsService");
                    registerRecommendationsClient(com.google.android.tvrecommendations.IRecommendationsClient.Stub.asInterface(data.readStrongBinder()), data.readInt());
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.tvrecommendations.IRecommendationsService");
                    unregisterRecommendationsClient(com.google.android.tvrecommendations.IRecommendationsClient.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface("com.google.android.tvrecommendations.IRecommendationsService");
                    registerPartnerRowClient(com.google.android.tvrecommendations.IRecommendationsClient.Stub.asInterface(data.readStrongBinder()), data.readInt());
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface("com.google.android.tvrecommendations.IRecommendationsService");
                    unregisterPartnerRowClient(com.google.android.tvrecommendations.IRecommendationsClient.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface("com.google.android.tvrecommendations.IRecommendationsService");
