...
public abstract class RecommendationsClient {
    ...
    public ComponentName getServiceComponent() {
        List<ResolveInfo> resolveInfoList = this.mContext.getPackageManager().queryIntentServices(new Intent("com.google.android.leanbacklauncher.recommendations.RecommendationsService"), 0);
