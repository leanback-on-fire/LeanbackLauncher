  ...
  implements Runnable
{
  ...
  private static Executor sExecutor = new ThreadPoolExecutor(CORE_THREAD_POOL_SIZE, MAX_THREAD_POOL_SIZE, 5L, TimeUnit.SECONDS, sWorkQueue);
  ...
  static DataLoadingBackgroundTask obtain(Context paramContext)
  {
    synchronized (POOL_SYNC)
    {
      ...
      {
        paramContext = sPool;
        sPool = paramContext.mNext;
        paramContext.mNext = null;
        sPoolSize -= 1;
        return paramContext;
      }
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/com/google/android/tvlauncher/data/DataLoadingBackgroundTask.class
