...
import com.google.android.tvlauncher.util.ExtendableTimer.Listener;
...
class DataSourceObserver
{
  ...
  private String buildProgramSelection(Set<Long> paramSet)
  {
    ...
    while (paramSet.hasNext()) {
      localStringBuilder.append(((Long)paramSet.next()).toString()).append(",");
    }
  ...
  private ExtendableTimerListener getTimerListener()
  {
    if (this.mExtendableTimerListener == null) {
      this.mExtendableTimerListener = new ExtendableTimerListener(null);
    }
  ...
  private void loadProgramData()
  {
    ...
    if (this.mBackgroundTaskCallbacks == null) {
      this.mBackgroundTaskCallbacks = new BackgroundTaskCallbacks(null);
    }
  ...
  {
    this.mProgramsToLoadData.add(Long.valueOf(paramLong));
  ...
  void register()
  {
    ...
    localContentResolver.registerContentObserver(TvContract.PreviewPrograms.CONTENT_URI, true, this.mContentObserver);
    ...
    public void onTaskCompleted(DataLoadingBackgroundTask paramDataLoadingBackgroundTask)
    {
      ...
      for (;;)
      {
        ...
        while (localCursor.moveToNext())
        {
          ...
          paramDataLoadingBackgroundTask = DataSourceObserver.this.mCallbacks.findCachedChannelId(l1);
          if ((paramDataLoadingBackgroundTask == null) || (paramDataLoadingBackgroundTask.longValue() != l2)) {
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/com/google/android/tvlauncher/data/DataSourceObserver.class
