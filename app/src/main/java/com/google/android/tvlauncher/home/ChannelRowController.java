  ...
  implements HomeRow, ChannelView.OnPerformMainActionListener, ChannelView.OnMoveChannelUpListener, ChannelView.OnMoveChannelDownListener, ChannelView.OnRemoveListener, ChannelView.OnStateChangeGesturePerformedListener, OnPerformLastProgramActionListener, EventLogger, BackHomeControllerListeners.OnBackPressedListener, BackHomeControllerListeners.OnHomePressedListener
{
  ...
  ChannelRowController(ChannelView paramChannelView, RequestManager paramRequestManager, EventLogger paramEventLogger)
  {
    ...
    final int i = paramChannelView.getContext().getColor(2131820579);
    this.mLogoPaletteGlideTarget = new ImageViewTarget(this.mChannelView.getChannelLogoImageView())
    {
      protected void setResource(PaletteBitmapContainer paramAnonymousPaletteBitmapContainer)
      {
        if (paramAnonymousPaletteBitmapContainer != null)
        {
          ...
          ((ImageView)this.view).setImageBitmap(localBitmap);
          if ((localBitmap == null) || (localBitmap.hasAlpha())) {
            ((ImageView)this.view).setBackgroundColor(i);
          }
          for (;;)
          {
            int i = paramAnonymousPaletteBitmapContainer.getPalette().getVibrantColor(paramAnonymousPaletteBitmapContainer.getPalette().getMutedColor(((ImageView)this.view).getContext().getColor(2131820577)));
  ...
  private void showAccessibilityMenu()
  {
    if (this.mAccessibilityContextMenu == null)
    {
      ...
      this.mAccessibilityContextMenu.addItem(new ContextMenuItem(0, localContext.getString(2131492901), localContext.getDrawable(2130837645)));
      this.mAccessibilityContextMenu.addItem(new ContextMenuItem(1, localContext.getString(2131492888), localContext.getDrawable(2130837635)));
      this.mAccessibilityContextMenu.addItem(new ContextMenuItem(2, localContext.getString(2131492885), localContext.getDrawable(2130837632)));
      this.mAccessibilityContextMenu.addItem(new ContextMenuItem(3, localContext.getString(2131492904), localContext.getDrawable(2130837668)));
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/com/google/android/tvlauncher/home/ChannelRowController.class
