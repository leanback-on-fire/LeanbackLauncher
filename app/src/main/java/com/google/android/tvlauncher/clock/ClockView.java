  ...
  extends TextClock
{
  ...
  private BroadcastReceiver mIntentReceiver = new BroadcastReceiver()
  {
    public void onReceive(Context paramAnonymousContext, Intent paramAnonymousIntent)
    {
      ...
      if (("android.intent.action.TIME_SET".equals(paramAnonymousContext)) || ("android.intent.action.TIMEZONE_CHANGED".equals(paramAnonymousContext)) || ("android.intent.action.LOCALE_CHANGED".equals(paramAnonymousContext))) {
        ClockView.this.updatePatterns();
      }
    }
  };
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/com/google/android/tvlauncher/clock/ClockView.class
