...
class PromotionRowAdapter
  extends RecyclerView.Adapter<PromotionViewHolder>
{
  ...
  {
    Program localProgram = this.mDataManager.getProgram(this.mChannelId, paramInt);
    PromotionViewHolder.access$002(paramPromotionViewHolder, localProgram.getActionUri());
    Glide.with(paramPromotionViewHolder.mPreviewImage.getContext()).load(localProgram.getPreviewImageUri()).into(paramPromotionViewHolder.mPreviewImage);
  }
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/com/google/android/tvlauncher/appsview/PromotionRowAdapter.class
