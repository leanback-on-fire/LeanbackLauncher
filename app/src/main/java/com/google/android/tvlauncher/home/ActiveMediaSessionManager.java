  ...
  implements MediaSessionManager.OnActiveSessionsChangedListener
{
  ...
  public boolean hasActiveMediaSession()
  {
    ...
    {
      return false;
      localPlaybackState = this.mActiveMediaController.getPlaybackState();
    } while ((localPlaybackState == null) || (localPlaybackState.getState() != 3));
    return true;
  }
  ...
  {
    if (paramList.size() == 0) {}
    for (paramList = null;; paramList = (MediaController)paramList.get(0))
    {
      this.mActiveMediaController = paramList;
      return;
    }
  }
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/com/google/android/tvlauncher/home/ActiveMediaSessionManager.class
