...
import com.google.android.leanbacklauncher.recline.util.CachedTaskPool.CacheItem;
import com.google.android.leanbacklauncher.recline.util.CachedTaskPool.TaskBuilder;
import com.google.android.leanbacklauncher.recline.util.CachedTaskPool.TaskCompleteCallback;
import com.google.android.leanbacklauncher.recline.util.CachedTaskPool.TaskOption;
...
public class DrawableDownloader {
    ...
    public static abstract class BitmapCallback extends TaskCompleteCallback<Drawable> {
    }
    ...
    /* renamed from: com.google.android.recline.util.DrawableDownloader.3 */
    class C02213 implements TaskBuilder {
        final /* synthetic */ BitmapWorkerOptions val$options;

        /* renamed from: com.google.android.recline.util.DrawableDownloader.3.1 */
        class C02201 extends CallbackDrawableLoader {
            ...
            protected Drawable doInBackground(TaskOption... params) {
        ...
        public AsyncTask<TaskOption, Void, Object> buildTask(TaskOption option, TaskCompleteCallback callback) {
    ...
    private static class BitmapItem extends CacheItem<BitmapDrawable> {
        int mOriginalHeight;
        int mOriginalWidth;
        ...
        public BitmapDrawable getItem(CachedTaskPool downloader, TaskOption option) {
    ...
    private void addBitmapToMemoryCache(BitmapWorkerOptions key, Drawable bitmap, DrawableLoader loader) {
        if (key.isMemCacheEnabled() && (bitmap instanceof BitmapDrawable)) {
            ...
            LruCache<String, CacheItem> memCache = this.mTaskPool.getMemCache();
