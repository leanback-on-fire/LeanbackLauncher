...
import com.google.android.leanbacklauncher.apps.ConnectivityListener.ConnectivityStatus;
import com.google.android.leanbacklauncher.notifications.NotificationsAdapter.NotificationCountListener;
import java.util.ArrayList;
import java.util.Collections;
import java.util.Comparator;

public class SettingsAdapter extends AppsAdapter implements NotificationCountListener {
    private final ConnectivityListener mConnectivityListener;
    private final Handler mHandler;
    private Resources mNetResources;
    private boolean mNetResourcesSet;

    /* renamed from: com.google.android.leanbacklauncher.apps.SettingsAdapter.1 */
    ...
    private LaunchPoint setNetwork(Resources res, LaunchPoint launchPoint) {
        ...
        ConnectivityStatus connectivityStatus = this.mConnectivityListener.getConnectivityStatus();
        int titleId = 0;
        String title = null;
