...
import com.google.android.leanbacklauncher.ActiveItemsRowView.RowCountChangeListener;
...
public class ActiveFrame extends LinearLayout implements ParticipatesInScrollAnimation, HomeScrollFractionListener, RowCountChangeListener {
    ...
    /* renamed from: com.google.android.leanbacklauncher.ActiveFrame.1 */
    ...
    protected void onFinishInflate() {
        ...
        if (this.mHeader != null) {
            ...
            this.mHeaderFadeInAnimation = new FadeAnimator(this.mHeader, Direction.FADE_IN);
        }
    }
