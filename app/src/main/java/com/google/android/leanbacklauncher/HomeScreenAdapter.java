...
public class HomeScreenAdapter extends Adapter<HomeScreenAdapter.HomeViewHolder> implements OnChildSelectedListener, RowChangeListener, Listener, OnEditModeChangedListener {
    ...
    /* renamed from: com.google.android.leanbacklauncher.HomeScreenAdapter.1 */
    ...
    /* renamed from: com.google.android.leanbacklauncher.HomeScreenAdapter.2 */
...
/*       if (!(row.getType() == 3 || row.getType() == 4)) {
    ...
    private Adapter<?> initAdapter(int type) {
        switch (type) {
            ...
            case android.support.v7.preference.R.styleable.Preference_android_key /*6*/:
                Adapter<?> adapter = new InputsAdapter(this.mMainActivity, new Configuration(this.mPartner.showPhysicalTunersSeparately(), this.mPartner.disableDiconnectedInputs(), this.mPartner.getStateIconFromTVInput()));
