...
public class LaunchPoint {
    ...
    /* renamed from: com.google.android.leanbacklauncher.apps.LaunchPoint.1 */
    class C01861 extends BitmapCallback {
        C01861() {
        }
    ...
    public LaunchPoint(Context context, String appTitle, String iconUrl, String pkgName, Intent launchIntent, boolean isGame, InstallingLaunchPointListener listener) {
        ...
        if (!TextUtils.isEmpty(iconUrl)) {
            ...
            DrawableDownloader.getInstance(context).getBitmap(new Builder(context).resource(Uri.parse(iconUrl)).width(maxIconSize).height(maxIconSize).cacheFlag(1).build(), this.mBitmapCallback);
        }
    }
