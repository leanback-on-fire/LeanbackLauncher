...
public final class MassSlideAnimator extends PropagatingAnimator<ViewHolder> implements Joinable {
    ...
    final class ViewHolder extends com.google.android.leanbacklauncher.animation.PropagatingAnimator.ViewHolder {
        final int[] mCenter;
        final float mEndY;
    ...
    private MassSlideAnimator(Builder builder) {
        ...
        float propagationSpeed = res.getFraction(R.fraction.slide_animator_propagation_speed, 1, 1);
