...
import com.google.android.leanbacklauncher.animation.ViewFocusAnimator.OnFocusLevelChangeListener;
...
import com.google.android.leanbacklauncher.trace.AppTrace.TraceTag;

public abstract class RecommendationView extends ViewGroup implements Target<Bitmap>, DimmableItem, ParticipatesInLaunchAnimation, ParticipatesInScrollAnimation, OnFocusLevelChangeListener {
    ...
    public RecommendationView(Context context) {
        ...
        this.mImageMaxWidth = a.getDimensionPixelSize(1, 0);
        this.mImageHeight = a.getDimensionPixelSize(4, 0);
        this.mProgressBarHeight = a.getDimensionPixelSize(5, 0);
        this.mInfoAreaPaddingStart = a.getDimensionPixelOffset(6, 0);
        this.mInfoAreaPaddingTop = a.getDimensionPixelOffset(7, 0);
        this.mInfoAreaPaddingEnd = a.getDimensionPixelOffset(8, 0);
        this.mInfoAreaPaddingBottom = a.getDimensionPixelOffset(9, 0);
        this.mInfoAreaCollapsedHeight = a.getDimensionPixelSize(10, 0);
        this.mInfoAreaDefaultColor = a.getColor(11, 0);
        float sourceNameTextSize = a.getDimension(12, 0.0f);
        int sourceNameTextColor = a.getColor(13, 0);
        this.mGapBetweenSourceNameAndBadge = a.getDimensionPixelOffset(14, 0);
        this.mBadgeSize = a.getDimensionPixelSize(15, 0);
        this.mBadgeMarginBottom = a.getDimensionPixelOffset(16, 0);
        float titleTextSize = a.getDimension(17, 0.0f);
        int titleTextColor = a.getColor(18, 0);
        float contentTextSize = a.getDimension(19, 0.0f);
        int contentTextColor = a.getColor(20, 0);
        a.recycle();
