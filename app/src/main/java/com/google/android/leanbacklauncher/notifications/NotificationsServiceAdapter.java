...
import com.google.android.tvrecommendations.IRecommendationsClient.Stub;
...
public abstract class NotificationsServiceAdapter<VH extends ViewHolder> extends NotificationsViewAdapter<VH> {
    ...
    private TraceTag mNotificationListenerTraceToken;
    ...
    private TraceTag mServiceConnectTraceToken;
    ...
    private static class NotificationsListener extends Stub {
