package com.google.android.leanbacklauncher.tvrecommendations;
    ...
    public static abstract class Stub extends Binder implements IRecommendationsService {
        ...
        private static class Proxy implements IRecommendationsService {
            ...
            public int getApiVersion() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken("com.google.android.tvrecommendations.IRecommendationsService");
        ...
        public Stub() {
            attachInterface(this, "com.google.android.tvrecommendations.IRecommendationsService");
        }
        ...
        public static IRecommendationsService asInterface(IBinder obj) {
            ...
            IInterface iin = obj.queryLocalInterface("com.google.android.tvrecommendations.IRecommendationsService");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case android.support.v7.recyclerview.R.styleable.RecyclerView_android_descendantFocusability /*1*/:
                    data.enforceInterface("com.google.android.tvrecommendations.IRecommendationsService");
                ...
                case android.support.v7.recyclerview.R.styleable.RecyclerView_layoutManager /*2*/:
                    data.enforceInterface("com.google.android.tvrecommendations.IRecommendationsService");
                    registerRecommendationsClient(com.google.android.leanbacklauncher.tvrecommendations.IRecommendationsClient.Stub.asInterface(data.readStrongBinder()), data.readInt());
                    reply.writeNoException();
                    return true;
                case android.support.v7.preference.R.styleable.Preference_android_layout /*3*/:
                    data.enforceInterface("com.google.android.tvrecommendations.IRecommendationsService");
                    unregisterRecommendationsClient(com.google.android.leanbacklauncher.tvrecommendations.IRecommendationsClient.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case android.support.v7.preference.R.styleable.Preference_android_title /*4*/:
                    data.enforceInterface("com.google.android.tvrecommendations.IRecommendationsService");
                    registerPartnerRowClient(com.google.android.leanbacklauncher.tvrecommendations.IRecommendationsClient.Stub.asInterface(data.readStrongBinder()), data.readInt());
                    reply.writeNoException();
                    return true;
                case android.support.v7.preference.R.styleable.Preference_android_selectable /*5*/:
                    data.enforceInterface("com.google.android.tvrecommendations.IRecommendationsService");
                    unregisterPartnerRowClient(com.google.android.leanbacklauncher.tvrecommendations.IRecommendationsClient.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                ...
                case android.support.v7.preference.R.styleable.Preference_android_fragment /*13*/:
                    ...
                    return true;
                case 1598968902:
                    reply.writeString("com.google.android.tvrecommendations.IRecommendationsService");
                    return true;
                default:
