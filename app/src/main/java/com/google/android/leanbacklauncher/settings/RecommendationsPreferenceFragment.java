...
public class RecommendationsPreferenceFragment extends LeanbackPreferenceFragment implements LoadRecommendationPackagesCallback, OnPreferenceChangeListener {
