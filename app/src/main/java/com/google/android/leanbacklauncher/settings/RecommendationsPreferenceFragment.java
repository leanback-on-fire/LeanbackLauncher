...
public class RecommendationsPreferenceFragment extends LeanbackPreferenceFragment implements OnPreferenceChangeListener, LoadRecommendationPackagesCallback {
    ...
    public void onRecommendationPackagesLoaded(List<PackageInfo> packages) {
        if (isAdded()) {
