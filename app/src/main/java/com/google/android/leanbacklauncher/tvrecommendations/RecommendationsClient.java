...
import com.google.android.leanbacklauncher.tvrecommendations.IRecommendationsService.Stub;
...
public abstract class RecommendationsClient {
    ...
    /* renamed from: com.google.android.tvrecommendations.RecommendationsClient.1 */
    class C02261 implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            if (RecommendationsClient.this.mConnectedOrConnecting) {
                RecommendationsClient.this.mBoundService = Stub.asInterface(service);
    ...
    protected Intent getServiceIntent() {
        Intent serviceIntent = new Intent("com.google.android.leanbacklauncher.recommendations.RecommendationsService");
