package com.google.android.leanbacklauncher.recline.app;
...
import com.google.android.leanbacklauncher.recline.app.DialogFragment.Action.OnFocusListener;
...
class DialogActionAdapter extends Adapter {
    ...
    /* renamed from: com.google.android.recline.app.DialogActionAdapter.1 */
    ...
    private static class ActionOnKeyPressAnimator implements OnKeyListener {
        ...
        /* renamed from: com.google.android.recline.app.DialogActionAdapter.ActionOnKeyPressAnimator.1 */
        class C02101 extends AnimatorListenerAdapter {
            final /* synthetic */ Action val$action;
            final /* synthetic */ boolean val$pressed;
            final /* synthetic */ View val$v;

            C02101(View val$v, boolean val$pressed, Action val$action) {
                this.val$v = val$v;
        ...
        /* renamed from: com.google.android.recline.app.DialogActionAdapter.ActionOnKeyPressAnimator.2 */
        ...
        public ActionOnKeyPressAnimator(Listener listener, List<Action> actions) {
    ...
    private static class ActionViewHolder extends ViewHolder {
        ...
        private boolean setIndicator(ImageView indicatorView, Action action) {
    ...
    public DialogActionAdapter(Listener listener, OnFocusListener onFocusListener, List<Action> actions) {
    ...
    public void onBindViewHolder(ViewHolder baseHolder, int position) {
        ...
        if (position < this.mActions.size()) {
            holder.init((Action) this.mActions.get(position));
        }
    }
