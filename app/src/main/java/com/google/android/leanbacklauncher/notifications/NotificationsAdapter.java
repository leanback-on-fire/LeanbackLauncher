...
import com.google.android.leanbacklauncher.OpaqueBitmapTransformation;
    ...
    private static class CardUpdateController {
        ...
        public void onServiceStatusChanged(boolean isReady) {
            synchronized (this) {
                ...
                if (isReady) {
                    Iterator it = this.mWaitingConnectionNofification.iterator();
                    while (it.hasNext()) {
                        NotifViewHolder notifViewHolder = (NotifViewHolder) it.next();
