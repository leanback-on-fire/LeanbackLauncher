  ...
  implements ReflectedParcelable
{
  ...
  ParcelFileDescriptor zzSC;
  private Bitmap zzaPB;
  ...
  BitmapTeleporter(int paramInt1, ParcelFileDescriptor paramParcelFileDescriptor, int paramInt2)
  {
    ...
    this.zzSC = paramParcelFileDescriptor;
  ...
  /* Error */
  private java.io.FileOutputStream zzza()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 68	com/google/android/gms/common/data/BitmapTeleporter:zzaPD	Ljava/io/File;
    //   4: ifnonnull +13 -> 17
    ...
    //   19: ldc 79
    //   21: aload_0
    //   22: getfield 68	com/google/android/gms/common/data/BitmapTeleporter:zzaPD	Ljava/io/File;
    ...
    //   45: putfield 36	com/google/android/gms/common/data/BitmapTeleporter:zzSC	Landroid/os/ParcelFileDescriptor;
    //   48: aload_1
  ...
  public Bitmap get()
  {
    Object localObject1;
    if (!this.zzaPC) {
      localObject1 = new DataInputStream(new ParcelFileDescriptor.AutoCloseInputStream(this.zzSC));
    }
    try
    {
      ...
      this.zzaPB = ((Bitmap)localObject2);
      this.zzaPC = true;
      return this.zzaPB;
    }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    if (this.zzSC == null)
    {
      ...
      localObject = new DataOutputStream(zzza());
    }
    try
    {
...
/* Location:              /home/evan/Downloads/fugu-opr2.170623.027-factory-d4be396e/fugu-opr2.170623.027/image-fugu-opr2.170623.027/TVLauncher/TVLauncher/TVLauncher-dex2jar.jar!/com/google/android/gms/common/data/BitmapTeleporter.class
