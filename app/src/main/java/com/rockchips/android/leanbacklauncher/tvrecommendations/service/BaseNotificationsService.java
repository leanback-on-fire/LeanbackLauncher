...
public abstract class BaseNotificationsService extends NotificationListenerService implements RecommendationsManager.NotificationResolver {
    ...
    private class BatchHandler extends Handler {
        ...
        L_0x0007:
            ...
            return;
        L_0x0009:
            r0 = com.rockchips.android.tvrecommendations.service.BaseNotificationsService.this;	 Catch:{ all -> 0x0039 }
            r1 = r0.mPostedBatch;	 Catch:{ all -> 0x0039 }
            monitor-enter(r1);	 Catch:{ all -> 0x0039 }
            r0 = com.rockchips.android.tvrecommendations.service.BaseNotificationsService.this;	 Catch:{ all -> 0x003c }
            r0 = r0.mManager;	 Catch:{ all -> 0x003c }
            r2 = com.rockchips.android.tvrecommendations.service.BaseNotificationsService.this;	 Catch:{ all -> 0x003c }
        ...
        L_0x003f:
            ...
            r1 = r0.mPostedBatch;	 Catch:{ all -> 0x0039 }
            monitor-enter(r1);	 Catch:{ all -> 0x0039 }
            r0 = com.rockchips.android.tvrecommendations.service.BaseNotificationsService.this;	 Catch:{ all -> 0x0060 }
            r0 = r0.mManager;	 Catch:{ all -> 0x0060 }
            r2 = com.rockchips.android.tvrecommendations.service.BaseNotificationsService.this;	 Catch:{ all -> 0x0060 }
        ...
        L_0x0063:
            ...
            monitor-enter(r1);	 Catch:{ all -> 0x0039 }
            r0 = com.rockchips.android.tvrecommendations.service.BaseNotificationsService.this;	 Catch:{ all -> 0x0084 }
            r0 = r0.mManager;	 Catch:{ all -> 0x0084 }
            r2 = com.rockchips.android.tvrecommendations.service.BaseNotificationsService.this;	 Catch:{ all -> 0x0084 }
        ...
        L_0x0084:
            ...
            throw r0;	 Catch:{ all -> 0x0039 }
        L_0x0087:
            r1 = com.rockchips.android.tvrecommendations.service.BaseNotificationsService.this;	 Catch:{ all -> 0x0039 }
        ...
        L_0x0096:
            ...
            goto L_0x0091;
            */
            //throw new UnsupportedOperationException("Method not decompiled: com.rockchips.android.tvrecommendations.service.BaseNotificationsService.BatchHandler.handleMessage(android.os.Message):void");
        }
    }
